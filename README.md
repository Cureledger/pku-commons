...
| [`docs/market/`](docs/market/) | The [PKU Market Atlas](docs/market.html): PKU as a market, not a biology. 414 cited records across coverage law, medical foods, formulas, drugs, companies, apps, medical devices, clinics, dental, mental health, restaurants, schools, payers, advocacy, and litigation, rendered as an investor-facing dashboard. |
