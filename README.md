...
| [`docs/market/`](docs/market/) | The [PKU Market Atlas](docs/market.html): PKU as a market, not a biology. 377 cited records across coverage law, medical foods, formulas, drugs, companies, apps, medical devices, clinics, restaurants, schools, payers, advocacy, and litigation, rendered as an investor-facing dashboard. |
